    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      <View className="flex-1 justify-between px-8 pt-12 pb-8 relative z-10">
        ...
        <View className="items-center mt-12">
          <View className="mb-6 p-4 bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 shadow-lg">
            <Image
        ...
        <View className="mb-4">
          <TouchableOpacity
            ...
            activeOpacity={0.9}
            className="bg-primary rounded-full py-4 px-8 flex-row items-center justify-center shadow-lg shadow-primary/30"
          >
