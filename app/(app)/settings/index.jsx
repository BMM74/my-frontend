...
import { Calendar, ChevronRight, Edit2, LogOut, Ruler, Settings, Shield, Target, User, Weight } from 'lucide-react-native';
...
const MENU_ITEMS = [
  ...
  { id: '5', label: 'Privacy', icon: Shield, href: '/settings/privacy' },
];
